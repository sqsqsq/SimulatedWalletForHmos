...
- `specs/phase-rules/ut-rules.yaml` — 阶段级通用规则
...
- **Prompt 模板**：`harness/prompts/verify-ut.md`
...
- 阶段级规约: `specs/phase-rules/ut-rules.yaml`
...
- 脚本 Harness: `harness/scripts/check-ut.ts`
- AI Harness Prompt: `harness/prompts/verify-ut.md`
- 下游消费者:
