...
```
skills/6-device-testing/templates/test-plan-template.md
```
...
```
skills/6-device-testing/templates/test-report-template.md
```
...
- `specs/phase-rules/testing-rules.yaml` — 阶段级通用规则
...
- **Prompt 模板**：`harness/prompts/verify-testing.md`
...
- 阶段级规约: `specs/phase-rules/testing-rules.yaml`
- 脚本 Harness: `harness/scripts/check-testing.ts`
- AI Harness Prompt: `harness/prompts/verify-testing.md`
