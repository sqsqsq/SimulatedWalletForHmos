...
**依据**: `specs/phase-rules/coding-rules.yaml > inter_module_dependency`
...
**依据**: `specs/phase-rules/coding-rules.yaml > layer_compliance`
...
**依据**: `specs/phase-rules/coding-rules.yaml > file_completeness`
...
**依据**: `specs/phase-rules/coding-rules.yaml > resource_integrity`
...
**依据**: `specs/phase-rules/coding-rules.yaml > naming_conventions`
...
**依据**: `specs/phase-rules/coding-rules.yaml > no_hardcoded_strings`
...
**依据**: `specs/phase-rules/coding-rules.yaml > no_any_type`
...
**依据**: `specs/phase-rules/coding-rules.yaml > async_await_pattern`
