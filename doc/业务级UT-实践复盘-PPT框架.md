...
> **演讲节奏建议**
> - P6 演进全景 + P8 v2 翻车 是全场 highlight，合计时间占 30%
> - P5 双 Harness 是技术干货高峰，建议现场演示一次 `check-ut.ts` 运行截图
> - P9 未解的坑可作为开放话题，邀请提问思路
