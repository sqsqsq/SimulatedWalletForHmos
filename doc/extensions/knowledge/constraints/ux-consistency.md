...
capabilities: [{id: ux-consistency, revision: 1, covers: [条目表, 落法附注]}]
---
...
|---|---|---|---|---|---|---|
| UX-01 | RTL 语言下界面镜像正确 | 基线 | 需求含 UI 变更 | 方向性参数用 start/end | 模型：检索 `left:`/`right:` 与非 Localized 方向参数。实机：切阿语走查 | 阻断：absent_regex:\b(left\|right)\s*: |
