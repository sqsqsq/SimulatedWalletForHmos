 ...
 * ## 这份文件解决什么
 *
 * 判断「哪条规约命中、本需求要求做什么」「哪些模式是候选」的真源是这份 YAML，
 * `spec.md` 的 §10/§11 两章是它的投影。作者只编辑 YAML，投影由生成器写：
 * 机械判据读结构不解析人写的表，投影与真源对不上时错的一定是投影。
 *
 * 现在倒过来：作者只编辑 `spec/knowledge-use.yaml`，§10/§11 是从它**确定性生成**的
 * 只读区。判断的真源是 YAML，人读的投影跟着它走；两者不一致时错的一定是投影。
 *
 * ## 三类知识各自的生命周期（合同）
 *
