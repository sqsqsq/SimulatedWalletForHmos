...
key_inputs_read:
  - "doc/features/home-page/device-testing-todo.md — 真机覆盖项与 AC 映射"
...
- 确认 `doc/features/home-page/` 下 Skill 6 输入：`device-testing-todo.md`、`test-plan.md`、`test-report.md`、`acceptance.yaml` 均已存在。
...
| 路径（相对仓库根） | 为何读 |
|-------------------|--------|
| doc/features/home-page/device-testing-todo.md | v2 真机待办来源 |
