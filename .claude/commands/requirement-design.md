...
# /requirement-design — 技术设计

**用户输入**：$ARGUMENTS

## 唯一指令

完整读一遍 [skills/2-requirement-design/SKILL.md](../../skills/2-requirement-design/SKILL.md)，按其中的 Step 0 → Step N 严格执行，产物路径、harness 命令、完成标准、BLOCKER 清单**全部以 SKILL.md 原文为准**。
