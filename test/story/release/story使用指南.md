...
> [1.9.5.md](1.9.5.md)（上一版 [1.9.4.md](1.9.4.md)）;流程全景与演进方向见 [需求交付流程.md](需求交付流程.md);
...
知识与需求系统对接脚本由目标工程按真实代码与真实系统维护，`/story adapt` 不碰它们；内网从 1.9.3 升级见[内网适配指南](内网适配指南-1.9.3升级1.9.6.md)。
