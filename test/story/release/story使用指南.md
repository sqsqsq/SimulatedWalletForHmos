...
> [1.9.4.md](1.9.4.md)（上一版 [1.9.3.md](1.9.3.md)）;流程全景与演进方向见 [需求交付流程.md](需求交付流程.md);
...
上报知识由目标工程单独维护：维护模型可使用[内网上报知识适配指南](内网上报知识适配指南.md)，依据真实代码修订 reporting 与 observability；这不是 `/story adapt` 的定制步骤。
