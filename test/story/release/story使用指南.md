...
> [1.9.0.md](1.9.0.md);流程全景与演进方向见 [需求交付流程.md](需求交付流程.md);
...
- 在 **`review.md`** 上表态——AI 已把每个待决点整理成议题:当前建议、为什么、
  影响哪里、请谁确认。
...
**Q5 story.md 能手工润色吗?**
不能,它由规格自动装配。要改内容改规格,重新装配即可——单一真源才不会出现
"评审看的和实现依据的不一致"。
...
1. **你评审的必然是最新的**——评审叙事由规格确定性装配,规格一改它必然跟着改;
