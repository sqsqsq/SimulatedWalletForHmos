...
知识与需求系统对接脚本由目标工程按真实代码与真实系统维护，`/story adapt` 不碰它们；升级时它按目标已适配到的版本列出知识、对接层与在途单要做的条目，逐版记录在 `doc/extensions/skills/story-adaptation/reference/upgrade-changes.md`。
