...
**关掉什么**：出问题时关闭开关即回退，回退只隐藏新入口。

**在途业务怎么办**：处理中的一切都保留——已提交的申请继续可查、未终结的上下文不删除、恢复能力不下线。

**为什么这样退是安全的**：挂失不可半途蒸发。用户的卡可能已经在冻结流程里，回退若清掉这些，用户既看不到入口也查不到结果，等于把最需要保护的人晾在中间。补卡侧的通知失败也不解释成冻结失败。
