...
| 7 Story 语义审查资格门 | **装置通过**；资格实跑已跑但**结论未取得**（三族点名确证、两族悬空，见记录） | [reviews/07-story-semantic-oracle.md](reviews/07-story-semantic-oracle.md) |
| 8 Story/Review 确定性生成 | **通过**（`4e9a6d21`；两条裁定见评审 §4） | 同上 |
| 9 正向 Story 作者路径切换 | **落盘机制已实施**；逐单元退场受退场次序阻塞（见记录） | 待生成 |
